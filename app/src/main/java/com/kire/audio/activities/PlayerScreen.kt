...
fun ModalBottomSheetTrackInfo(
    ...
    ModalBottomSheet(
        ...
        containerColor = com.kire.audio.ui.theme.BackGroundLightGray,
                ...
                .clickable(
                    ...
                    if (selectList == ListSelector.FAVOURITE_LIST && track.isFavourite) {
                        ...
                        if (currentTrackList.size == 1) {
                            ...
                            durationSet(currentTrackList[newINDEX].duration.toFloat())
            ...
            Icon(
                ...
                modifier = Modifier
                    ...
                    .clickable(
                        ...
                        val newINDEX =
                            if (
                                tracks[trackINDEX].imageUri == imageUri
                        ...
                        durationSet(tracks[newINDEX].duration.toFloat())

                        sentInfoToBottomSheet(
                            tracks[newINDEX],
                            selectList,
                            newINDEX,
                            tracks[newINDEX].path
                        )

                        val newMediaItem =
                            MediaItem.fromUri(Uri.parse(tracks[newINDEX].path))

                        backward(newMediaItem)
                    }
            )
            ...
            Icon(
                ...
                modifier = Modifier
                    ...
                    .clickable(
                        ...
                        val newINDEX =
                            if (tracks[trackINDEX].imageUri == imageUri
                                && tracks[trackINDEX].title == title
                                && tracks[trackINDEX].artist == artist
                            )
